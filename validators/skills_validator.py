...
def validar_skills_por_curso(curso, hard_skills_dict, soft_skills_dict):
    """
    Valida se as skills fornecidas são válidas para o curso especificado
    
    Args:
        curso (str): Nome do curso
        hard_skills_dict (dict): Dicionário com hard skills e valores
        soft_skills_dict (dict): Dicionário com soft skills e valores
